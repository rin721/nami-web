...
Rin UI is a Web Components UI library for applications that need one component source across multiple frontend stacks. The public surface is custom elements, reflected attributes, DOM events, slots, CSS parts, and CSS variables.
...
<div class="doc-live-stack">
  <rl-button>Install Rin UI</rl-button>

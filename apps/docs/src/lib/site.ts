...
const messages = {
  'zh-CN': {
    ...
    'nav.vibe': '工程方法',
    'nav.settings': '设置',
    'home.eyebrow': 'Nami UI 0.1.0',
    'home.subtitle': '跨框架、可换肤的 Web Components UI 组件库',
    'home.lead': '使用标准 Web Components 构建应用界面。Nami UI 提供轻量组件、暗色模式、主题算法、CSS Parts、语义结构和可解释 token，适合原生 HTML、Vue、React 与长期维护的设计系统。',
    'home.install': '安装',
    'home.openDocs': '快速开始',
    'home.openDesigner': '打开主题设计器',
    'home.openComponents': '浏览组件',
    'home.vibeTitle': '一套组件源码，多套视觉系统',
    'home.vibeCopy': '默认风格与插画风格共用同一套 nami-* 组件。accent、dark、density、size、radius、contrast、motion 等 seed 会派生完整 token，并通过 CSS Parts 与组件 token 保持安全定制边界。',
    'home.framework': '跨框架',
    'home.themeable': '可换肤',
    'home.accessible': '可访问',
    'home.metadata': '元数据驱动',
    'home.libraryTitle': '组件库官网应从真实使用路径开始',
    'home.libraryCopy': '首页只保留产品定位、安装入口、组件入口和主题入口；教程、API、质量基线和站点设置各归其位。',
    'home.pathStartCopy': '安装包，选择全量注册或单组件导入，再引入主题 CSS。',
    'home.pathComponentsCopy': '按界面任务浏览组件，并进入详情页查看示例、API、Slots、Parts 和 Tokens。',
    'home.pathThemeCopy': '用同一套 seed 控制主题色、明暗模式、风格预设、密度、尺寸、圆角、对比度和动效。',
    'home.pathResourcesCopy': '质量基线、国际化、设计规范、更新日志和 FAQ 集中在资源区，不混入组件参考页。',
    'controls.theme': '主题控制',
    'controls.locale': '语言',
    'controls.light': '浅色',
    'controls.dark': '深色',
    ...
    'component.tokens': '主题 Tokens',
    'component.a11y': '可访问性说明',
    'components.title': '组件',
    'components.copy': '组件按标准 UI 任务分组：通用、布局、导航、数据录入、数据展示、反馈和系统。每个组件页只承载组件参考，不重复主题教程或站点设置。',
    'components.statsComponents': '公开组件',
    'components.statsComponentsCopy': '具备稳定 metadata 与 package exports 的 custom elements。',
    'components.statsGroups': '标准分类',
    ...
    'tokens.copy': 'Nami UI 把换肤边界放在 CSS 变量和确定性主题算法之后。组件只消费 semantic、component 和 style tokens。',
    'theme.title': '主题系统',
    'theme.copy': '从少量 seed 派生完整视觉系统：品牌色、明暗模式、风格预设、密度、尺寸、圆角、对比度和动效都会同步影响组件。',
    ...
    'resources.title': '资源',
    'resources.copy': '设计规范、质量、i18n、语义结构、更新日志和 FAQ 集中放在资源区；这里不承载组件 API，也不重复主题教程。',
    'lab.title': '主题矩阵',
    'lab.copy': '验证默认风格、插画风格、明暗模式、主题色、密度和动效的组合。',
    'designer.title': '主题设计器',
    'designer.copy': '编辑 seed 值，查看派生 token，并复制确定性的 CSS、DTCG JSON 和 TS 配置。',
    ...
    'settings.title': '设置',
    'settings.copy': '管理官网外观、页面过渡、语言、代码示例偏好、主题配置导出与实验能力。',
    'settings.appearance': '外观',
    'settings.transition': '页面过渡',
    'settings.language': '语言',
    'settings.preferences': '偏好',
    'settings.config': '配置导出',
    'settings.experimental': '实验',
    'settings.about': '关于',
    'settings.scheme': '配色模式',
    'settings.palette': '主题色',
    'settings.customPalette': '自定义主色',
    'settings.size': '全局尺寸',
    'settings.codeExamples': '代码示例',
    ...
    'settings.progressEffect': '动画动作',
    'settings.progressDuration': '填充动画',
    'settings.preview': '预览',
    'settings.rememberTheme': '保留主题状态',
    'settings.compactDocs': '紧凑文档布局',
    'settings.experimentalCopy': '实验性设置会优先保持可逆和可测试。',
    'settings.aboutCopy': 'Nami UI 是标准 Web Components 组件库，官网使用自家组件展示主题、配置和组件参考能力。',
  ...
  'en-US': {
    ...
    'home.lead': 'Build application interfaces with standard Web Components. Nami UI ships lightweight components, dark mode, a theme algorithm, CSS Parts, semantic anatomy, and explainable tokens for Native HTML, Vue, React, and long-lived design systems.',
    ...
    'home.vibeCopy': 'Default and illustration styles use the same nami-* components. Accent, dark mode, density, size, radius, contrast, and motion seeds derive the full token system while CSS Parts and component tokens stay safe to customize.',
    'home.framework': 'Framework agnostic',
    'home.themeable': 'Themeable',
    'home.accessible': 'Accessible',
    'home.metadata': 'Metadata driven',
    'home.libraryTitle': 'A component library site should start with real user paths',
    'home.libraryCopy': 'The home page keeps product positioning, install entry points, component entry points, and theme entry points. Tutorials, APIs, quality baselines, and site settings each live in their own area.',
    ...
    'home.pathThemeCopy': 'Switch accent, light/dark mode, style preset, density, size, radius, contrast, and motion from the same seed model.',
    'home.pathResourcesCopy': 'Quality baselines, i18n, design guidance, changelog, and FAQ live together without crowding component references.',
    ...
    'components.copy': 'Components are grouped by standard UI tasks: general, layout, navigation, data entry, data display, feedback, and system. Each component page stays focused on component reference instead of duplicating theme tutorials or site settings.',
    ...
    'components.statsGroups': 'Standard groups',
    ...
    'theme.copy': 'A small set of seeds derives the full visual system: accent, color mode, style preset, density, size, radius, contrast, and motion all update components together.',
    ...
    'resources.copy': 'Design guidance, quality, i18n, semantic anatomy, changelog, and FAQ live in Resources. This area does not duplicate component APIs or theme tutorials.',
    ...
    'designer.copy': 'Edit seed values, inspect derived tokens, and copy deterministic CSS, DTCG JSON, and TS config.',
    ...
    'settings.copy': 'Manage docs appearance, page transitions, language, code example preferences, theme exports, and experimental capabilities.',
    'settings.appearance': 'Appearance',
    'settings.transition': 'Page transition',
    'settings.language': 'Language',
    'settings.preferences': 'Preferences',
    'settings.config': 'Config export',
    'settings.experimental': 'Experimental',
    'settings.about': 'About',
    'settings.scheme': 'Scheme',
    'settings.palette': 'Palette',
    'settings.customPalette': 'Custom primary',
    'settings.size': 'Global size',
    'settings.codeExamples': 'Code examples',
    ...
    'settings.progressEffect': 'Animation effect',
    ...
    'settings.aboutCopy': 'Nami UI is a standards-based Web Components library. The docs site uses its own components to present themes, configuration, and component references.',
...
void i18n.init({
  ...
  resources: Object.fromEntries(docsLocales.map((locale) => [locale, { translation: messages[locale] }]))
});

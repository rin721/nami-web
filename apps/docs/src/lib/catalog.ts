...
export const componentGroups = [
  { id: 'themeLayout', title: { 'zh-CN': '主题与布局', 'en-US': 'Theme and Layout' }, names: ['rl-config', 'rl-theme', 'rl-app-shell', 'rl-card'] },
  { id: 'actionsSelection', title: { 'zh-CN': '操作与选择', 'en-US': 'Actions and Selection' }, names: ['rl-button', 'rl-icon-button', 'rl-badge', 'rl-chip', 'rl-tab-bar'] },
  { id: 'forms', title: { 'zh-CN': '表单', 'en-US': 'Forms' }, names: ['rl-input', 'rl-switch', 'rl-radio-card'] },
  { id: 'feedbackOverlays', title: { 'zh-CN': '反馈与浮层', 'en-US': 'Feedback and Overlays' }, names: ['rl-spinner', 'rl-dialog', 'rl-drawer', 'rl-toast', 'rl-illustration', 'rl-empty', 'rl-result'] }
];

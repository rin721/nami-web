...
const docsMessages: Record<string, () => string> = {
  ...
  'docs.nav.designer': () => msg('Designer', { id: 'docs.nav.designer' }),
  ...
  'docs.controls.radiusSharp': () => msg('Sharp radius', { id: 'docs.controls.radiusSharp' }),
  'docs.controls.radiusSoft': () => msg('Soft radius', { id: 'docs.controls.radiusSoft' }),
  'docs.controls.radiusRound': () => msg('Round radius', { id: 'docs.controls.radiusRound' }),
  'docs.controls.highContrast': () => msg('High contrast', { id: 'docs.controls.highContrast' }),
  ...
  'docs.common.category': () => msg('Category', { id: 'docs.common.category' }),
  'docs.common.states': () => msg('States', { id: 'docs.common.states' }),
  'docs.common.semanticAnatomy': () => msg('Semantic anatomy', { id: 'docs.common.semanticAnatomy' }),
  'docs.common.styleHooks': () => msg('Style hooks', { id: 'docs.common.styleHooks' }),
  ...
  'docs.designer.eyebrow': () => msg('Theme Designer', { id: 'docs.designer.eyebrow' }),
  'docs.designer.title': () => msg('Open algorithm, semantic output', { id: 'docs.designer.title' }),
  'docs.designer.copy': () => msg('Edit seed values, inspect derived tokens, and copy deterministic CSS variables without any AI service dependency.', { id: 'docs.designer.copy' }),
  'docs.designer.seedControls': () => msg('Seed controls', { id: 'docs.designer.seedControls' }),
  'docs.designer.preview': () => msg('Resolved preview', { id: 'docs.designer.preview' }),
  'docs.designer.tokenTree': () => msg('Derived token tree', { id: 'docs.designer.tokenTree' }),
  'docs.designer.generatedCss': () => msg('Generated CSS', { id: 'docs.designer.generatedCss' }),
  'docs.designer.affected': () => msg('Affected components', { id: 'docs.designer.affected' }),
...
const componentSummaryMessages: Record<string, () => string> = {
  ...
  'rl-theme': () => msg('Theme, accent, density, motion, radius, contrast, and style preset boundary.', { id: 'docs.meta.rl-theme.summary' }),

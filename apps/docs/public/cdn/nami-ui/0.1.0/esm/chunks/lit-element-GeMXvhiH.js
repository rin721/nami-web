const U = globalThis, k = U.ShadowRoot && (U.ShadyCSS === void 0 || U.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, D = /* @__PURE__ */ Symbol(), B = /* @__PURE__ */ new WeakMap();
let X = class {
  constructor(t, e, s) {
...
const rt = (r) => new X(typeof r == "string" ? r : r + "", void 0, D), Pt = (r, ...t) => {
...
const { is: ot, defineProperty: ht, getOwnPropertyDescriptor: at, getOwnPropertyNames: lt, getOwnPropertySymbols: ct, getPrototypeOf: dt } = Object, M = globalThis, V = M.trustedTypes, pt = V ? V.emptyScript : "", ut = M.reactiveElementPolyfillSupport, S = (r, t) => r, R = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? pt : null;
      break;
  ...
  return e;
} }, Y = (r, t) => !ot(r, t), W = { attribute: !0, type: String, converter: R, reflect: !1, useDefault: !1, hasChanged: Y };
...
const L = globalThis, q = (r) => r, H = L.trustedTypes, Z = H ? H.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, tt = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, et = "?" + _, $t = `<${et}>`, m = document, b = () => m.createComment(""), w = (r) => r === null || typeof r != "object" && typeof r != "function", z = Array.isArray, _t = (r) => z(r) || typeof r?.[Symbol.iterator] == "function", T = `[ 	
\f\r]`, E = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, J = /-->/g, K = />/g, f = RegExp(`>|${T}(?:([^\\s"'>=/]+)(${T}*=${T}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), F = /'/g, G = /"/g, st = /^(?:script|style|textarea|title)$/i, ft = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), Ut = ft(1), g = /* @__PURE__ */ Symbol.for("lit-noChange"), d = /* @__PURE__ */ Symbol.for("lit-nothing"), Q = /* @__PURE__ */ new WeakMap(), A = m.createTreeWalker(m, 129);
function it(r, t) {
...
const At = (r, t) => {
  ...
  for (let l = 0; l < e; l++) {
    const h = r[l];
    let c, p, a = -1, u = 0;
    for (; u < h.length && (o.lastIndex = u, p = o.exec(h), p !== null); ) u = o.lastIndex, o === E ? p[1] === "!--" ? o = J : p[1] !== void 0 ? o = K : p[2] !== void 0 ? (st.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = f) : p[3] !== void 0 && (o = f) : o === f ? p[0] === ">" ? (o = i ?? E, a = -1) : p[1] === void 0 ? a = -2 : (a = o.lastIndex - p[2].length, c = p[1], o = p[3] === void 0 ? f : p[3] === '"' ? G : F) : o === G || o === F ? o = f : o === J || o === K ? o = E : (o = f, i = void 0);
    const $ = o === f && r[l + 1].startsWith("/>") ? " " : "";
    n += o === E ? h + $t : a >= 0 ? (s.push(c), h.slice(0, a) + tt + h.slice(a) + _ + $) : h + _ + (a === -2 ? l : $);
  }
...
class C {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let n = 0, o = 0;
    const l = t.length - 1, h = this.parts, [c, p] = At(t, e);
    ...
    for (; (i = A.nextNode()) !== null && h.length < l; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const a of i.getAttributeNames()) if (a.endsWith(tt)) {
          ...
          h.push({ type: 1, index: n, name: x[2], strings: $, ctor: x[1] === "." ? yt : x[1] === "?" ? gt : x[1] === "@" ? vt : N }), i.removeAttribute(a);
...
class P {
  ...
  _$AI(t, e = this) {
    t = v(this, t, e), w(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== g && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : _t(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
St?.(C, P), (L.litHtmlVersions ??= []).push("3.3.3");
const bt = (r, t, e) => {

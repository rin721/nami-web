...
function deriveComponent(seed: NamiResolvedThemeSeed): Record<string, string> {
  ...
  return {
    ...
    '--nami-radio-item-bg': illustration ? 'var(--nami-style-control-bg)' : 'transparent',
    '--nami-radio-item-border-width': illustration ? 'var(--nami-style-stroke-width)' : high ? '2px' : '1px',
    '--nami-radio-item-border-color': illustration ? 'var(--nami-style-stroke-color)' : 'var(--nami-border)',
    ...
    '--nami-radio-item-description-color': illustration ? 'var(--nami-style-on-paper-muted)' : 'var(--nami-text-muted)',
    ...
    '--nami-tooltip-bg': illustration ? 'var(--nami-style-control-bg)' : 'var(--nami-text)',
    '--nami-tooltip-fg': illustration ? 'var(--nami-style-on-paper)' : 'var(--nami-text-inverse)',
    '--nami-tooltip-border-width': illustration ? 'var(--nami-style-stroke-width)' : '0',
    '--nami-tooltip-border-color': illustration ? 'var(--nami-style-stroke-color)' : 'transparent',
    '--nami-tooltip-radius': illustration ? 'var(--nami-radius-tight)' : 'var(--nami-radius-tight)',
    '--nami-tooltip-shadow': illustration ? 'var(--nami-style-offset-shadow)' : `0 8px 24px ${transparent('var(--nami-shadow-color)', 72)}`,
    ...
    '--nami-top-progress-appear-duration': seed.motion === 'reduced' ? '1ms' : '360ms',
    ...
    '--nami-divider-color': illustration ? 'var(--nami-style-stroke-color)' : 'var(--nami-border)',
    '--nami-divider-thickness': illustration ? 'var(--nami-style-stroke-width)' : high ? '2px' : '1px',
    '--nami-divider-gap': 'var(--nami-space-3)',
    '--nami-divider-label-color': illustration ? 'var(--nami-style-on-paper-muted)' : 'var(--nami-text-muted)',

...
const namiComponentMetadataSource: NamiComponentMetadataSource[] = [
  ...
  },
  {
    ...
    attributes: ['active', 'label', 'variant', 'tone', 'appearance', 'duration', 'progress', 'bar-height', 'progress-duration'],
    properties: ['active', 'label', 'variant', 'tone', 'appearance', 'duration', 'progress', 'barHeight', 'progressDuration', 'show()', 'hide()', 'waitFor()'],
    events: [],
    slots: ['default', 'icon'],
    parts: ['base', 'track', 'indicator', 'brand', 'panel', 'label'],
    tokens: ['--nami-motion-fast', '--nami-motion-normal', '--nami-surface', '--nami-surface-overlay', '--nami-text', '--nami-color-primary', '--nami-border', '--nami-dialog-border-width', '--nami-dialog-radius', '--nami-dialog-shadow', '--nami-spinner-track-color', '--nami-style-background-pattern', '--nami-style-stroke-width', '--nami-page-transition-bar-height', '--nami-page-transition-progress-duration', '--nami-page-transition-track-bg', '--nami-page-transition-fill-bg', '--nami-page-transition-z-index'],
    category: 'feedback',

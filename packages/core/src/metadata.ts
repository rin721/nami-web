...
const namiComponentMetadataSource: NamiComponentMetadataSource[] = [
  ...
  },
  {
    ...
    usage: '<nami-top-progress active progress="64" height="4" appear="true"></nami-top-progress>',
    attributes: ['active', 'progress', 'height', 'duration', 'appear', 'appear-duration', 'effect', 'variant', 'label'],
    properties: [
      'active',
      'progress',
      'height',
    ...
    tokens: [
      ...
      '--nami-top-progress-appear-duration',
  ...
  },
  {
    ...
    usage: '<nami-scroll-smoother preset="balanced" duration="1.2" touch-multiplier="2" anchors></nami-scroll-smoother>',
    attributes: [
      'disabled',
      'preset',
      'duration',
